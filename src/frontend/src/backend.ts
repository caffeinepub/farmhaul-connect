...
export class Backend implements backendInterface {
    ...
    async cancelRequest(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async completeDelivery(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeDelivery(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createRequest(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllRequests(): Promise<Array<PickupRequest>> {
        if (this.processError) {
            try {
    ...
    async getAvailableRequests(): Promise<Array<PickupRequest>> {
        if (this.processError) {
            try {
    ...
    async getMyTrips(): Promise<Array<PickupRequest>> {
        if (this.processError) {
            try {
    ...
    async getRequestById(arg0: bigint): Promise<PickupRequest | null> {
        if (this.processError) {
            try {
...
function from_candid_PickupRequest_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PickupRequest): PickupRequest {
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PickupRequest]): PickupRequest | null {
    return value.length === 0 ? null : from_candid_PickupRequest_n4(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userRole: from_candid_UserRole_n13(_uploadFile, _downloadFile, value.userRole),
        name: value.name,
        phone: value.phone
    };
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        transporterId: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.transporterId)),
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "cancelled" in value ? RequestStatus.cancelled : "pending" in value ? RequestStatus.pending : "delivered" in value ? RequestStatus.delivered : "accepted" in value ? RequestStatus.accepted : "inProgress" in value ? RequestStatus.inProgress : value;
}
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PickupRequest>): Array<PickupRequest> {
    return value.map((x)=>from_candid_PickupRequest_n4(_uploadFile, _downloadFile, x));
}
...
function to_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userRole: to_candid_UserRole_n1(_uploadFile, _downloadFile, value.userRole),
        name: value.name,
        phone: value.phone
    };
}
